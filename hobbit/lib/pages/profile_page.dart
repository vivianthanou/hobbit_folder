...
class ProfileData extends ChangeNotifier {
  ...
  void updateUsername(String newName,int userId) async {
    ...
    //DATABASE
    var url = Uri.parse('http://192.168.43.86:5000/updateUsername');
  ...
  void updatedDescription(String newDescription,int userId) async {
    ...
    //DATABASE
    var url = Uri.parse('http://192.168.43.86:5000/updateDescription');
    var response = await http.post(
      url,
      headers: {'Content-Type': 'application/json; charset=UTF-8'},
  ...
  void updateProfileImage(Uint8List newImage, int userId) async {
    ...
    var url = Uri.parse('http://192.168.43.86:5000/updateImage');
    var response = await http.post(
      url,
      headers: {'Content-Type': 'application/json; charset=UTF-8'},
  ...
  void updateInterests(String newInterest, int userId) async {
    ...
    var url = Uri.parse('http://192.168.43.86:5000/updateInterests');
    var response = await http.post(
      url,
      headers: {'Content-Type': 'application/json; charset=UTF-8'},
  ...
  Future<void> fetchUserData(int userId) async {
    var url = Uri.parse('http://192.168.43.86:5000/getdata?userId=$userId');
